...
urlpatterns = [
    ...
    path('edit_diagnostic_opinion', edit_diagnostic_opinion, name='edit_diagnostic_opinion'),
    path('edit_handling_opinion', edit_handling_opinion, name='edit_handling_opinion'),
    path('edit_note', edit_note, name='edit_note'),
    path('get_total_patient_info', get_total_patient_info, name='get_total_patient_info'),
